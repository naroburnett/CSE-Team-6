class Railroad():
    def __init__(self):
        ...
        self.cost = None
        self.rent = None
        self.owned = [None, None, None, None]
        self.mortgage = None
        self.is_mortgage = 0
        self.no_owned = 0
        self.owner = None
    ...
    def set_owned(self,rent,index):
        """Updates the property railroad rents to the given ones.
        
        Args:
            rent (cost): The given railroad property rent.
            index (railroad): the railroad rent to be changed in list. 
        """
    ...
    def set_no_owned(self, no_owned):
        """Updates the amount of railroads owned to the given one.
        
        Args:
            no_owned : The given amount of railroads owned.
        """
    ...
    def get_owned(self,index):
        """Gets updated rent cost with amount of railroads owned.
        
        Returns:
            number: The property updated rent with amount of railroads owned.
        """
    ...
    def get_no_owned(self):
        """Gets current amount of railroads owned.
        
        Returns:
            Number: The amount of railroads currently owned.
        """
